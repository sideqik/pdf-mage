...
// Landscape / Portrait
let longerDimension = 1270;
let shorterDimension = 720;

let isLandscape = argv.landscape || true;
let width = argv.width || isLandscape ? longerDimension : shorterDimension;
let height = argv.height || isLandscape ? shorterDimension : longerDimension;
